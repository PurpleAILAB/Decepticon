...
**Anti-pattern (XBEN-097 cycle 5)**: 19 minutes spent on view.php parameter guessing before discovering the alias off-by-one. With this probe in standard recon discovery, the misconfig would be flagged in <30s.
